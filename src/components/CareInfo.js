                ...
                <div className="info-border">
                    ...
                    <div className="info-content">
                        ...
                        <div className="pic_zone-right">
                            <img className="info-pic" src={ require('../img/Information/care.jpg') }  alt="care-pic"/>
                        </div>
                        ...
                        <br/><br/>Tips to storage a silk
                        <br/>&emsp;&emsp;&emsp;When folded a silk it will cause wrinkles in silk, to reduce this problem you can roll a silk instead of fold a silk.
                        <br/><br/>
                        Tips to protect a silk from an insects
                        <br/>&emsp;&emsp;&emsp;If we rarely use a silk and keep it in a closet it could have insects destroy fabric.
                        ...
                        <div className="info-ref">
                            References: “Facebook.” การดูแลรักษาผ้าไหมไทย, www.facebook.com/notes/ดาหวันไหมไทย/การดูแลรักษาผ้าไหมไทย/916689258365515/.
                        </div>
                    </div>        
                </div>            
            </div>
